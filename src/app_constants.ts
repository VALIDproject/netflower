...
export class AppConstants {
  ...
  static SAMPLES = [
    ...
    { title: 'Interruptions in Parliament (by Member)',
      description: 'The transcription of debates in the Austrian Parliament were analyzed by the VALiD team to quantify interruptions during speeches in plenary session. The dataset at hand shows interruptions by member of parliament, party of interrupted speaker, and calendar year; coverage 2008-2018 (incomplete)',
      file: 'https://dl.dropboxusercontent.com/s/hnjpm9vuanelfwv/zwr_person_year-tag.csv?dl=0',
      source: 'https://www.parlament.gv.at/PAKT/STPROT/'},
    { title: 'Interruptions in Parliament (by Party)',
      description: 'The transcription of debates in the Austrian Parliament were analyzed by the VALiD team to quantify Interruptions during speeches in plenary session. The dataset at hand shows interruptions by party of interruptor, party of interrupted speaker, and period of legislature.',
      file: 'https://dl.dropboxusercontent.com/s/2vfswyxo5p5jlvp/zwr_partei_per.csv?dl=0',
      source: 'https://www.parlament.gv.at/PAKT/STPROT/'},
    // { title: '',
    //   description: '',
    //   file: '',
