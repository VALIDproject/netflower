...
export class AppConstants {
  ...
  static SAMPLES = [
    ...
    { title: 'Incivility in Parliament (Speaker)',
      description: 'Transcription of debates in the Austrian Parliament were analyzed by the VALiD team to quantify incivility. The dataset at hand shows instances of incivility by speaker, adressed party, and calendar year; coverage 2008-2018 (incomplete)',
    ...
    { title: 'Incivility in Parliament (Party)',
      description: 'Transcription of debates in the Austrian Parliament were analyzed by the VALiD team to quantify incivility. The dataset at hand shows instances of incivility by party of speaker, adressed party, and period of legislature.',
